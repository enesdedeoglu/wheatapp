    ...
    routes: [
        StackRouter.of({
            ...
            routes: [
                Route.of({
                    path: "/pages/page1",
                    build: buildExtender({ getPageClass: () => require("pages/page1"), headerBarStyle: { visible: false} })
                }),
                Route.of({
                    path: "/pages/page2",
                    build: buildExtender({ getPageClass: () => require("pages/page2"), headerBarStyle: { visible: false } })
                }),
            ]
        })
    ]
